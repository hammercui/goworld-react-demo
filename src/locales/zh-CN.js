 ...
 * @LastEditTime: 2021-07-06 11:12:46
 */
export default {
  'navBar.lang': '语言',
  ...
  'menu.appDev.apiDocs': '接口文档列表',
  'menu.systemManage': '系统管理',
  'menu.systemManage.member': '人员管理',
  ...
  'menu.appScript': '剧本杀',
  'menu.appScript.merchant': '商铺',
  'menu.appScript.merchant.merchant': '商铺审核',
  'menu.appScript.merchant.script': '剧本审核',
  'menu.appScript.merchant.picture': '图片审核',
  'menu.appScript.newsList': '剧本圈',
  'menu.appScript.banner': 'banner图管理',
  'menu.appScript.banner.mainPageBanner': '首页banner图管理',
  'menu.appScript.banner.openAd': '开屏广告管理',
  'menu.appScript.money': '提现',
  'menu.appScript.money.scriptBeansWithdrawal': '剧本豆提现',
  'menu.appScript.flow': '流水',
  'menu.appScript.flow.auditFlow': '审核流水',
  'menu.appScript.flow.scriptFlow': '剧本修改流水',
  'menu.appScript.user': '用户',
  'menu.appScript.user.userInfo': '用户查询',
  'menu.appScript.user.reportInfo': '举报查询',
  'menu.appScript.script': '剧本审核',
  'menu.appScript.picture': '图片审核',
  'menu.appScript.scriptRecommend': '热门剧本',
  'menu.appScript.auditFlow': '审核流水',
  'menu.appScript.scriptFlow': '剧本修改流水',
  'menu.appExchange': '交易系统',
  'menu.appExchange.project': '项目管理',
  'menu.appScript.operation': '运营',
  'menu.appScript.operation.ScriptNotice': '公告',
  'menu.appExchange.projectOpreate': '项目管理流水',
};
